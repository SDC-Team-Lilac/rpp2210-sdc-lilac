...
const ReviewsList = ( { reviews, sortReviews, updateReviews, reviewsMeta, updateReviewCount, characteristicSelections }) => {
  ...
  return (
    ...
    <div data-testid='reviewList-1' style={{border: '5px solid blue'}}>
      ...
      {showNewReview && createPortal(
        <NewReview reviewsMeta={reviewsMeta} characteristicSelections={characteristicSelections} onClose={hideModal}/>,
        document.body
      )}
