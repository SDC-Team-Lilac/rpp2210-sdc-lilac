  ...
  return (
    <div data-testid='reviews-1' style={{border: '2px solid red'}}>
      <div className="reviews reviewsMain">
        ...
        { filteredReviews.length !== 0 ? <ReviewList reviews={filteredReviews}  sortReviews={sortReviews} updateReviews={updateReviews} reviewsMeta={reviewsMeta} characteristicSelections={characteristicSelections}/> : 'There are no reviews!'}
      </div>
    </div>
  )
}
